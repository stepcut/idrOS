...
{
    terminal_writestring("alloc_heap");
    h->heap   = 0x100000;
    h->next   = h->heap;
...
VAL *nullary_cons;
VAL nullary_cons_cl[256];

void initNullaries() {
    int i;
    VAL cl;
    nullary_cons = nullary_cons_cl;
